...
export default function Join() {
    return (
        <main className="bg-gradient-to-b from-[#0A0B31] to-[#000138] pb-20 sm:pb-30">
            <div className="flex flex-col items-center text-center justify-center py-10 w-full sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-7xl mx-auto">
