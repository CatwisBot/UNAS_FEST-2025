...
const MainCommittee: React.FC = () => {
  ...
  return (
    <section className="bg-[#000022] text-white min-h-auto py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute top-[15%] left-[18%] w-[350px] h-[350px] rounded-full blur-circle bg-[radial-gradient(circle_at_center,_rgba(81,124,255,0.6)_0%,_rgba(81,124,255,0)_70%)] -z-10"></div>
      <div className="absolute top-[55%] left-[62%] w-[350px] h-[350px] rounded-full blur-circle bg-[radial-gradient(circle_at_center,_rgba(81,124,255,0.6)_0%,_rgba(81,124,255,0)_70%)] -z-10"></div>
