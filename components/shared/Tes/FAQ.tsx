...
import { FaqData, FaqItem as FaqItemType } from "@/constants/Tes/Faq";
...
const Faq = () => {
  ...
  return (
    <div className="relative bg-[#3a175d] w-full min-h-[600px] md:min-h-[700px] lg:min-h-[800px] xl:min-h-[900px] overflow-visible">

      {/* FAQ Content */}
      <div className="relative z-10 w-full pt-10 sm:pt-10 md:pt-10 pb-12 sm:pb-16 md:pb-24 px-4 sm:px-6 lg:px-8">
