...
const navigationMenuTriggerStyle = cva(
  "group inline-flex w-max items-center justify-center rounded-md text-xl font-medium focus:outline-none disabled:pointer-events-none disabled:opacity-50"
);
