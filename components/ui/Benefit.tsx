...
const cards = [
  ...
  },
  {
    ...
    cornerBg: "bg-[#653F71]",
    description:
      "Exclusive trophies for champions as a symbol of the highest achievement in each competition category.",
    items: [
  ...
  },
  {
    ...
    cornerBg: "bg-[#603086]",
    description:
      "Merchandise from UNAS FEST and sponsors will be presented to finalists during the awarding ceremony as a mark of recognition and appreciation.",
    items: ["UNAS Merch", "UNAS FEST Merch", "Sponsor Merch"],
  ...
  },
  {
    ...
    items: ["Champion", "Best Team", "Most Creative"],
...
//     cornerBg: "bg-[#057B56]",
//     description:
//       "An official of appreciation from the Rector of UNAS to all participants as a token of appreciation for their dedication and participation.",
//     items: ["All Participant", "Award", "Hard Copy"],
      ...
      >
        ...
        >
          {[...cards, ...cards].map((card, index) => (
            ...
            >
              <div
                className={`absolute top-0 right-0 w-15 h-15 ${card.cornerBg} rounded-bl-3xl`}
              ></div>
              <div
                className={`w-15 h-15 flex items-center justify-center bg-gradient-to-r ${card.iconBg} rounded-lg mb-4 relative z-10`}
              >
                <Image
                  src={card.icon}
                  alt={`${card.title} Icon`}
              ...
              <ul className="space-y-2 text-sm relative z-10">
                {card.items.map((item, idx) => (
                  <li key={idx} className="flex items-center gap-2">
                    <span
                      className={`w-2 h-2 rounded-full ${card.bulletColor}`}
                    ></span>
      ...
      <div className="hidden sm:block">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-7xl mx-auto">
          ...
          <div className="relative max-w-sm bg-gradient-to-br from-[#4D258E] to-[#2b146b] text-white p-6 rounded-2xl shadow-lg overflow-hidden">
            ...
            <p className="text-sm text-[#E1CBF9] mb-4 leading-relaxed relative z-10">
              Official digital certificate from Universitas Nasional that can be
              used to complement your academic and professional portfolio.
            </p>
          ...
          <div className="relative max-w-sm bg-gradient-to-br from-[#4D258E] to-[#2b146b] text-white p-6 rounded-2xl shadow-lg overflow-hidden">
            ...
            <h3 className="text-xl font-bold mb-2 relative z-10">Trophy</h3>
            ...
            <ul className="space-y-2 text-sm relative z-10">
              ...
              <li className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#EAB308]"></span>
                <span className="font-semibold text-white">Special Awards</span>
              </li>
            </ul>
          </div>
          ...
          <div className="relative max-w-sm bg-gradient-to-br from-[#4D258E] to-[#2b146b] text-white p-6 rounded-2xl shadow-lg overflow-hidden sm:col-span-2 lg:col-span-1 sm:mx-auto">
            ...
            <h3 className="text-xl font-bold mb-2 relative z-10">Merch</h3>

            <p className="text-sm text-[#E1CBF9] mb-4 leading-relaxed relative z-10">
              The UNAS FEST 2025 limited edition merchandise collection is only
              available to competition participants and winners.
            </p>

            <ul className="space-y-2 text-sm relative z-10">
              <li className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#A855F7]"></span>
                <span className="font-semibold text-white">UNAS Merch</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#A855F7]"></span>
                <span className="font-semibold text-white">
              ...
              <li className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#A855F7]"></span>
                <span className="font-semibold text-white">Sponsor Merch</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="pt-8 flex justify-center w-full max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-7xl mx-auto mx-auto">
          {/* Card 4 */}
          <div className="relative bg-gradient-to-br from-[#4D258E] to-[#2b146b] text-white p-6 rounded-2xl shadow-lg overflow-hidden">
            ...
            <h3 className="text-xl font-bold mb-2 relative z-10">Plaque</h3>
          ...
          <div className="relative bg-gradient-to-br from-[#4D258E] to-[#2b146b] text-white p-6 rounded-2xl shadow-lg overflow-hidden">
            ...
            <p className="text-sm text-[#E1CBF9] mb-4 leading-relaxed relative z-10">
              ...
              participants as a token of appreciation for their dedication and
              participation.
            </p>
